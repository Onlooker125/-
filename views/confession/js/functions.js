...
function timeElapse(c, is) {
  if (is) {
    ...
    var e = new Date()
    var meetYear = c.getFullYear()
    var nowYear = e.getFullYear()
    let year = nowYear-meetYear
    var f = (Date.parse(e) - Date.parse(c)) / 1000
    var g = Math.floor(f / (3600 * 24))
    var a = '<span class="digit">' + year + '</span> years OR <span class="digit">' + g + '</span> days'
    $("#lovetop").html(a)
  }
}
